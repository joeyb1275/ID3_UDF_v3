...
#cs #ID3.au3 UDF Latest Changes.......: ;====================================================================
	...
	Release 3.1 - 20120519
 	...
 	Release 3.2  TODO
		...
		-TODO -APEv2 - work with iTunes APE tag
...
;todo add more MPEG functions to get MPEG information
...
;~ 		MsgBox(0,"$APE_Version",$APE_Version)
...
;~ 		MsgBox(0,"$APETAG",$APETAG_ID & @CRLF & "TagVersion = " & $APE_Version & @CRLF & "TagSize = " & $APE_TagSize)
		FileSetPos($hFile, -($iID3v1_ByteOffset+$APE_TagSize), $FILE_END)
